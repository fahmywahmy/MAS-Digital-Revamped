-- GENERATED — do not hand-edit. Source: procrastinate 3.9.0 bundled schema.
-- Regenerate: python scripts/show-procrastinate-schema.py
-- Installs the durable-queue objects into a DEDICATED `procrastinate` schema,
-- isolated from the Prisma-owned public tables. NOT part of the Prisma chain.
-- Reversible: scripts/apply-procrastinate-schema.py --uninstall
